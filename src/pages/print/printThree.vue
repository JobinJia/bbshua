<template>
  <div>
    <div style="width:900px;margin:0 auto;" id="subOutputRank-print">
      <div
      ...
      <div style="border:1px solid #ddd;border-bottom:0px;padding:5px;">
        <div style="height:24px;line-height:24px;font-size:14px;"><span
          style="font-weight:600;margin-right:10px;">【订单编号】</span><span>{{list.order_sn}}</span></div>
        <div style="height:24px;line-height:24px;font-size:14px;"><span
          style="font-weight:600;margin-right:10px;">【物流方式】</span><span>{{list.send_type}}</span></div>
        <div style="height:24px;line-height:24px;font-size:14px;"><span
          style="font-weight:600;margin-right:10px;">【订单收货信息】</span><span>收货人:{{list.order_address.name}}</span>
        </div>
      </div>
      <!--
       <div style="border:1px solid #ddd;border-bottom:0px;padding:5px;">
      ...
      <table class="table table-bordered" style="margin-bottom:0px;">
        ...
        <tr style="height:24px; line-height:24px;">
          <th style="height:24px; line-height:24px;width:17%;font-size:14px;font-weight:600;">品种代码</th>
          <th style="height:24px; line-height:24px;width:32%;font-size:14px;font-weight:600;">商品名称</th>
          <th style="height:24px; line-height:24px;width:17%;font-size:14px;font-weight:600;">等级</th>
          <th style="height:24px; line-height:24px;width:17%;font-size:14px;font-weight:600;">规格</th>
          <th style="height:24px; line-height:24px;width:17%;font-size:14px;font-weight:600;">数量(扎)</th>
        </tr>
        </tbody>
      </table>
      <div
      ...
      <table class="table table-bordered" style="border-top:0px;margin-bottom:0px;">
        ...
        <tr style="height:30px;" v-for="item in list.spec_good" :key="item.id">
          <td style="width:17%;font-size:14px;font-weight:400;">{{item.brand}}</td>
          <td style="width:32%;font-size:14px;font-weight:400;">{{item.good_name}}</td>
          <td style="width:17%;font-size:14px;font-weight:400;">{{item.spec}}</td>
          <th style="width:17%;font-size:14px;font-weight:400;">{{item.unit}}</th>
          <th style="width:17%;font-size:14px;font-weight:400;">{{item.count}}</th>
        </tr>
        </tbody>
      </table>
      <div
